const items=[
    [
	    {src: process.env.PUBLIC_URL + '/img/메이킹/민 마인크래프트/IMG_3109.JPG',
	    altText:'민', caption:'민', header:'마인크래프트 월드 만들기',
	    },
	    {src: process.env.PUBLIC_URL + '/img/메이킹/민 마인크래프트/IMG_3110.JPG',
	    },
	    {src:process.env.PUBLIC_URL + '/img/메이킹/민 마인크래프트/IMG_3111.JPG',
	    },
        {src:process.env.PUBLIC_URL + '/img/메이킹/민 마인크래프트/IMG_3112.JPG',
	    }
    ],
    [
	    {src: process.env.PUBLIC_URL + '/img/메이킹/마크_물라스틱 레고블럭/IMG_3087.JPG',
	    altText:'마크', caption:'마크', header:'물라스틱 레고 만들기',
	    },
	    {src: process.env.PUBLIC_URL + '/img/메이킹/마크_물라스틱 레고블럭/IMG_3088.JPG',
	    },
	    {src:process.env.PUBLIC_URL + '/img/메이킹/마크_물라스틱 레고블럭/IMG_3089.JPG',
	    },
        {src:process.env.PUBLIC_URL + '/img/메이킹/마크_물라스틱 레고블럭/IMG_3090.JPG',
	    }
    ],
    [
	    {src: process.env.PUBLIC_URL + '/img/메이킹/젤로 캣타워/젤로_캣타워4.gif',
	    altText:'Jelo', caption:'Jelo', header:'캣 타워 만들기',
	    },
	    {src: process.env.PUBLIC_URL + '/img/메이킹/젤로 캣타워/젤로_캣타워1.jpg',
	    },
	    {src:process.env.PUBLIC_URL + '/img/메이킹/젤로 캣타워/젤로_캣타워2.jpg',
	    },
        {src:process.env.PUBLIC_URL + '/img/메이킹/젤로 캣타워/젤로_캣타워4.jpg',
	    }
    ],
    [
